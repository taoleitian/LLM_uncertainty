...
def arg_parser():
    ...
    parser.add_argument(
        "--max_tokens", type=int, default="60", help="api keys"
    ) 
    parser.add_argument(
    ...
    parser.add_argument(
        #"--dataset_path", type=str, default='dataset/CSQA/dev_rand_split.jsonl', help="api keys"dataset/CSQA/train_rand_split.jsonl
...
def build_input_and_labels(lines, COINFLIP_EXAMPLES, args):
    ...
    for line in lines:
        ...
        prompt = 'Answer the following question to the best of your ability, and provide a score between 0 and 1 to indicate the logit of each option. Logit scores closer to 0 indicate this option have less likelihood to be the right answer, while bigger logit scores indicate this option is more likeli to be the right answer. The answer is the option with the biggest logit. \n\n'
...
def main():
    ...
    COINFLIP_EXAMPLES = load_dataset('dataset/president/pred_logit.jsonl')
